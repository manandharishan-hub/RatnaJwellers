  ...
  return (
    <div className="space-y-10 px-6 py-16 md:px-10 lg:px-16">
      ...
      <div className="space-y-6 rounded-[2rem] border border-slate-200 bg-white p-10 shadow-sm text-slate-600">
        ...
        <p>Payments are securely completed through eSewa. Ratna does not collect eSewa wallet credentials. Account credentials are protected by industry-standard hashing and encryption.</p>
      </div>
    </div>
  );
}
